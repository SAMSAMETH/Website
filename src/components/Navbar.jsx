...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white/90 backdrop-blur-md shadow-sm fixed w-full z-50 top-0 left-0 border-b border-gray-100 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-6 py-3 flex justify-between items-center">
        ...
        >
          <img src={logo} alt="Ziterate Logo" className="w-18 h-20 object-contain" />
          <div>
          ...
          {user ? (
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="border border-[#b18e2a] text-[#b18e2a] px-4 py-1 rounded-lg hover:bg-[#faf5ff] transition duration-200 shadow-md"
              >
                Logout
              </button>
            </div>
